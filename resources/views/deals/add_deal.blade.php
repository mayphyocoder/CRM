...
@section('content')
    <div class="content-wrapper">
        ...
        <div class="content">
            <div class="card">
                <div class="card-body">
                    <h4 class="text-black m-b-3">Add Deal</h4>
                    <form action="{{ route('add-deal') }}" method="POST" class="form-horizontal form-bordered">
                        @csrf
                        <div class="row ">
                                            ...
                                            <fieldset class="form-group">
                                                ...
                                                <select class="form-control" name="contact_id">
                                                    ...
                                                    @foreach ($contacts as $contact)
                                                        <option value="{{ $contact->id }}">{{ $contact->contact_name }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                                @error('contact_id')
